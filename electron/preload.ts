...
const api: VoidLensApi = {
  ...
  getInventoryDiffHistory: () => ipcRenderer.invoke('inventory:diffHistory'),
  clearInventoryDiffHistory: () => ipcRenderer.invoke('inventory:diffHistoryClear'),
  getSessionHaul: () => ipcRenderer.invoke('session:haul'),
  clearSessionHaul: () => ipcRenderer.invoke('session:haulClear'),
  getSessionLedger: () => ipcRenderer.invoke('session:ledger'),
  ...
  getArbitrationAnalytics: () => ipcRenderer.invoke('arb:analytics'),
  clearArbitrationLog: () => ipcRenderer.invoke('arb:logClear'),
  suggestMarketUndercut: (name) => ipcRenderer.invoke('market:undercut', name),
  getMarketPriceHistory: (name) => ipcRenderer.invoke('market:priceHistory', name),
  ...
  pickCloudSyncFolder: () => ipcRenderer.invoke('settings:cloudPickFolder'),
  clearCloudSyncPath: () => ipcRenderer.invoke('settings:cloudClear'),
  pushCloudSettings: () => ipcRenderer.invoke('settings:cloudPush'),
  pullCloudSettings: (force?: boolean) => ipcRenderer.invoke('settings:cloudPull', force),
